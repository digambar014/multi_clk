...
class alignas(VL_CACHE_LINE_BYTES) Vmulti_clk_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __Vdlyvval__multi_clk_tb__DOT__clk_slow__v0;
    CData/*0:0*/ __Vdlyvset__multi_clk_tb__DOT__clk_slow__v0;
    CData/*0:0*/ __Vdlyvval__multi_clk_tb__DOT__clk_fast__v0;
    CData/*0:0*/ __Vdlyvset__multi_clk_tb__DOT__clk_fast__v0;
